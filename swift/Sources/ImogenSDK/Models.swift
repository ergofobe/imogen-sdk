...
/// This is the response path, and in four ports. Swift, Rust, Python and Kotlin apply it on
...
/// on the way *out* in any port: those bounds bite only whoever calls a parse, which in
